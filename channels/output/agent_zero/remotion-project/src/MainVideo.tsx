...
const DataCard: React.FC<{
  ...
  <div style={{
    ...
    <div style={{ fontSize: 18, color: C.text, fontFamily: "Noto Sans JP, sans-serif", lineHeight: 1.4 }}>
      {detail}
    </div>
  </div>
);
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: C.bg }}>
        ...
        return (
          <>
            ...
            <div style={{ position: "absolute", top: 80, left: 0, right: 0, textAlign: "center", opacity: p }}>
              ...
              <div style={{ fontSize: 60, fontWeight: 900, color: C.text, fontFamily: "Noto Sans JP, sans-serif", lineHeight: 1.3 }}>
                AIを使ったら
              </div>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "baseline", gap: 12, marginTop: 8 }}>
                ...
                <span style={{ fontSize: 48, fontWeight: 900, color: C.text, fontFamily: "Noto Sans JP, sans-serif" }}>遅くなった</span>
              </div>
              {/* Perception gap */}
              {idx >= 3 && (
                <div style={{
                  ...
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: 14, color: C.muted, marginBottom: 4 }}>本人の認識</div>
                    <div style={{ fontSize: 48, fontWeight: 900, color: C.green }}>+24%</div>
                    <div style={{ fontSize: 14, color: C.green }}>速くなった</div>
                  </div>
                  <div style={{ width: 2, background: `${C.muted}33` }} />
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: 14, color: C.muted, marginBottom: 4 }}>実際</div>
                    <div style={{ fontSize: 48, fontWeight: 900, color: C.red }}>-19%</div>
                    <div style={{ fontSize: 14, color: C.red }}>遅くなった</div>
                  </div>
                  <div style={{ width: 2, background: `${C.muted}33` }} />
                  <div style={{ textAlign: "center" }}>
                    <div style={{ fontSize: 14, color: C.muted, marginBottom: 4 }}>ギャップ</div>
                    <div style={{ fontSize: 48, fontWeight: 900, color: C.orange }}>43pt</div>
                    <div style={{ fontSize: 14, color: C.orange }}>認識の差</div>
                  </div>
                </div>
              )}
            </div>
          ...
          <>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", alignItems: "flex-end", gap: 24 }}>
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 16, color: C.muted }}>のコードをAIが記述</div>
                  </div>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 16, color: C.muted }}>品質改善</div>
                  </div>
                </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 22, color: C.text, fontFamily: "Noto Sans JP", textAlign: "center", marginTop: 4 }}>
                  のCEOがAI投資から<span style={{ color: C.red, fontWeight: 800 }}>リターンゼロ</span>
                </div>
                {/* Pie visualization */}
                <div style={{ display: "flex", justifyContent: "center", marginTop: 16, gap: 24 }}>
                  {[
                    { pct: 56, label: "ゼロ", color: C.red },
                    { pct: 32, label: "一部効果", color: C.orange },
                    { pct: 12, label: "両方成功", color: C.green },
                  ].map((s) => (
            ...
            {idx >= 4 && (
              <div style={{
                ...
                fontSize: 28, color: C.yellow, fontFamily: "Noto Sans JP", fontWeight: 700,
        ...
        return (
          <>
            <div style={{ fontSize: 16, color: C.accent, fontFamily: "JetBrains Mono, monospace", letterSpacing: 3, position: "absolute", top: 24, right: 40 }}>
              原因 {phase < 3 ? phase + 1 : 3} / 3{phase === 3 ? " + BONUS" : ""}
            </div>
            ...
            {phase === 0 && (
              <div style={{
                ...
                <div style={{ fontSize: 28, color: C.text, fontFamily: "Noto Sans JP", marginBottom: 20 }}>
                  AIで節約した時間の行方
                </div>
                {/* Stacked bar */}
                <div style={{ width: 800, height: 60, borderRadius: 12, display: "flex", overflow: "hidden", border: `1px solid ${C.muted}22` }}>
                  <div style={{ width: "60%", background: `linear-gradient(90deg, ${C.green}, ${C.accent})`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontSize: 22, fontWeight: 800, color: C.bg }}>60% 実際に節約</span>
                  </div>
                  <div style={{ width: "40%", background: `linear-gradient(90deg, ${C.red}cc, ${C.orange}cc)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontSize: 22, fontWeight: 800, color: "#fff" }}>40% 確認・修正に消失</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {phase === 1 && (
              <div style={{
                ...
                <div style={{ fontSize: 18, color: C.muted, fontFamily: "JetBrains Mono, monospace", marginBottom: 8 }}>BCG × HARVARD 2026 — 1,488人調査</div>
                <div style={{ fontSize: 36, fontWeight: 900, color: C.orange, fontFamily: "Noto Sans JP", marginBottom: 20 }}>
                  AI Brain Fry（脳の焼損）
                </div>
                <div style={{ display: "flex", gap: 20 }}>
                  {[
                    { stat: "+39%", label: "重大ミス増加", color: C.red, icon: "⚠" },
                    { stat: "+33%", label: "判断疲れ増加", color: C.orange, icon: "🧠" },
                    { stat: "+19%", label: "情報過負荷", color: C.yellow, icon: "📊" },
                    { stat: "+14%", label: "精神的負荷", color: C.secondary, icon: "😵" },
                  ].map((d, i) => (
                    <div key={d.label} style={{
                      ...
                      <div style={{ fontSize: 16, color: C.text, fontFamily: "Noto Sans JP", marginTop: 4 }}>{d.label}</div>
                    </div>
                  ))}
                </div>
                {/* Threshold */}
                <div style={{
                  ...
                  <span style={{ fontSize: 22, color: C.text, fontFamily: "Noto Sans JP" }}>
                    AIツール <span style={{ color: C.red, fontWeight: 900, fontSize: 28 }}>4つ以上</span> で生産性が逆転する
                  </span>
                </div>
              </div>
            )}
            ...
            {phase === 2 && (
              <div style={{
                ...
                <div style={{ display: "flex", gap: 32, justifyContent: "center" }}>
                  {[
                    { value: "9.5", unit: "分", desc: "集中力の復帰時間", color: C.orange },
                    { value: "1,200", unit: "回/日", desc: "アプリ切り替え回数", color: C.red },
                    { value: "3.2", unit: "時間", desc: "8時間中の損失", color: C.red },
                  ].map((d, i) => (
                    <div key={d.desc} style={{
                      ...
                      <div style={{ fontSize: 18, color: C.text, fontFamily: "Noto Sans JP", marginTop: 8 }}>{d.desc}</div>
                    </div>
                  ))}
                </div>
                {/* Timeline bar showing 8 hours */}
                <div style={{ marginTop: 24, padding: "0 40px" }}>
                  <div style={{ fontSize: 16, color: C.muted, marginBottom: 8 }}>8時間の内訳</div>
                  <div style={{ height: 40, borderRadius: 8, display: "flex", overflow: "hidden" }}>
                    <div style={{ width: "40%", background: `linear-gradient(90deg, ${C.red}cc, ${C.orange}cc)`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <span style={{ fontSize: 16, fontWeight: 700, color: "#fff" }}>3.2h 切替ロス</span>
                    </div>
                    <div style={{ width: "60%", background: `${C.green}44`, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <span style={{ fontSize: 16, fontWeight: 700, color: C.green }}>4.8h 実作業</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {phase === 3 && (
              <div style={{
                ...
                <div style={{ fontSize: 32, fontWeight: 900, color: C.text, fontFamily: "Noto Sans JP", marginBottom: 20 }}>
                  AIコードのセキュリティ欠陥率
                </div>
                <div style={{ display: "flex", gap: 24 }}>
                  {/* Bar chart of vulnerability rates */}
                  {[
                    { lang: "全体", pct: 45, color: C.orange },
                    { lang: "Java", pct: 72, color: C.red },
                    { lang: "XSS脆弱性", pct: 86, color: C.red },
                    { lang: "ログ注入", pct: 88, color: C.red },
                  ].map((d, i) => {
                    ...
                    return (
                      <div key={d.lang} style={{ flex: 1, textAlign: "center" }}>
                        ...
                        <div style={{ fontSize: 16, color: C.text, fontFamily: "Noto Sans JP" }}>{d.lang}</div>
                      </div>
                    );
                  })}
                </div>
              ...
              <div style={{
                ...
                <div style={{ display: "flex", gap: 24, marginTop: 24 }}>
                  <div style={{ flex: 1, background: `${C.surface}cc`, borderRadius: 16, padding: 24, border: `1px solid ${C.muted}22` }}>
                    <div style={{ fontSize: 56, fontWeight: 900, color: C.secondary, fontFamily: "Space Grotesk" }}>700人</div>
                    <div style={{ fontSize: 20, color: C.text, fontFamily: "Noto Sans JP" }}>カスタマーサポートをAIに置換</div>
                  </div>
                  ...
                  <div style={{ flex: 1, background: `${C.surface}cc`, borderRadius: 16, padding: 24, border: `1px solid ${C.red}33` }}>
                    ...
                    <div style={{ fontSize: 20, color: C.text, fontFamily: "Noto Sans JP" }}>顧客満足度が低下</div>
                  </div>
                  <div style={{ fontSize: 48, color: C.muted, alignSelf: "center" }}>→</div>
                  <div style={{ flex: 1, background: `${C.surface}cc`, borderRadius: 16, padding: 24, border: `1px solid ${C.green}33` }}>
                    <div style={{ fontSize: 56, fontWeight: 900, color: C.green, fontFamily: "Space Grotesk" }}>再雇用</div>
                    <div style={{ fontSize: 20, color: C.text, fontFamily: "Noto Sans JP" }}>人間を呼び戻した</div>
                  </div>
                </div>
                {/* CEO quote */}
                <div style={{
                  ...
                  <div style={{ fontSize: 18, color: C.orange, fontStyle: "italic", fontFamily: "Noto Sans JP" }}>
                    "コスト削減を重視しすぎた。その結果品質が落ちた" — CEO Sebastian Siemiatkowski
                  </div>
                </div>
              </div>
            )}
              ...
              <div style={{
                ...
                <div style={{ display: "flex", gap: 32 }}>
                  <div style={{ flex: 1, background: `${C.surface}cc`, borderRadius: 20, padding: 32, border: `1px solid ${C.red}33`, textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 22, color: C.text, fontFamily: "Noto Sans JP" }}>のAIプロジェクトが<br/>6ヶ月でROI出せず</div>
                  </div>
                  <div style={{ flex: 1, background: `${C.surface}cc`, borderRadius: 20, padding: 32, border: `1px solid ${C.green}33`, textAlign: "center" }}>
                    ...
                    <div style={{ fontSize: 22, color: C.text, fontFamily: "Noto Sans JP" }}>だけが大きな価値を創出<br/><span style={{ color: C.primary }}>共通点：選択的AI導入</span></div>
                  </div>
                </div>
              </div>
            )}
      ...
      {scene === "ResolutionScene" && (() => {
        ...
        const rules = [
          { num: "01", icon: "🔧", title: "ツールは3つまで", detail: "4つ以上 → Brain Fry\n重大ミス+39%", color: C.primary, source: "BCG 2026" },
          { num: "02", icon: "⏱", title: "確認 > 本体なら不採用", detail: "節約時間の40%が\n確認に消える", color: C.accent, source: "Workday 2026" },
          { num: "03", icon: "🔒", title: "セキュリティは人間", detail: "AIコードの45%に欠陥\n新モデルでも未改善", color: C.red, source: "Veracode 2025" },
        ];
        return (
          <>
            <div style={{ position: "absolute", top: 40, left: 0, right: 0, textAlign: "center" }}>
              <div style={{ fontSize: 18, color: C.muted, fontFamily: "Space Grotesk", letterSpacing: 4 }}>CONCLUSION</div>
              <div style={{ fontSize: 40, fontWeight: 900, color: C.text, fontFamily: "Noto Sans JP", marginTop: 4 }}>
                上位5%に入る3つのルール
              </div>
            </div>
              ...
              {rules.map((r, i) => {
                ...
                return (
                  <div key={r.num} style={{
                    ...
                    <div style={{ fontSize: 26, fontWeight: 800, color: r.color, fontFamily: "Noto Sans JP", marginBottom: 8 }}>{r.title}</div>
                    <div style={{ fontSize: 20, color: C.text, fontFamily: "Noto Sans JP", whiteSpace: "pre-line", lineHeight: 1.5 }}>{r.detail}</div>
      ...
      {scene === "OutroScene" && (() => {
        ...
        return (
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontSize: 40, fontWeight: 900, color: C.text, fontFamily: "Noto Sans JP", marginBottom: 36 }}>
              毎週AIをデータで検証中
            </div>
            <div style={{ display: "flex", gap: 24, alignItems: "center", marginBottom: 40 }}>
              <div style={{
                background: "#ff0000", borderRadius: 8, padding: "14px 44px",
                fontSize: 26, fontWeight: 800, color: "#fff", fontFamily: "Noto Sans JP",
            ...
            <div style={{
              ...
              <span style={{ fontSize: 18, color: C.muted }}>次回 → </span>
              <span style={{ fontSize: 20, color: C.text, fontFamily: "Noto Sans JP" }}>
                AIが存在しないライブラリを推薦する「スロップスクワッティング」の闇
              </span>
            </div>
          </div>
        );
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              fontFamily: "Noto Sans JP", lineHeight: 1.4,
            }}>{dialogue.text}</span>
          </div>
        </div>
      )}
